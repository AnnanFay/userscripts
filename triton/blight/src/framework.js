...
(function () {
  ...
  NP2M.post_init = function post_init(Mousetrap, Crux, NeptunesPride, universe, mgi, mgic, mg, si) {
    var data = {
      "Mousetrap": Mousetrap,
      "Crux": Crux,
      "NeptunesPride": NeptunesPride,
      "universe": universe || NeptunesPride.universe,
      "inbox": NeptunesPride.inbox,
      "npui": NeptunesPride.npui,
      "npuis": NeptunesPride.npuis,
      "np": NeptunesPride.np,
      "si": si || NeptunesPride.si,
      "mgi": mgi,
      "mgic": mgic,
      "mg": mg
    };
